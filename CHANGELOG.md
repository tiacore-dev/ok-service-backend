...
- Исправлена видимость согласованных смен: пользователь видит вложения своей
  смены после согласования и может их просматривать/скачивать; `user`,
  `project-leader` и `manager` не могут изменять вложения согласованной смены.
  API и миграции не изменялись.
- Уточнено удаление вложений смены: `user` может удалить вложение своей
  неподписанной смены, но не может удалить его после согласования.
- Расширена только видимость вложений объектов и мест: любой `manager` и
  `project-leader` могут просматривать и скачивать их; права изменения не
  изменялись.
