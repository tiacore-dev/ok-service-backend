...
def upgrade() -> None:
    ...
    op.create_table('object_statuses',
        sa.Column('object_status_id', sa.VARCHAR(), nullable=False),
        sa.Column('name', sa.VARCHAR(), nullable=False),
    ...
    op.create_table('shift_report_details',
        sa.Column('shift_report_details_id', sa.UUID(), nullable=False),
        sa.Column('shift_report_id', sa.UUID(), nullable=False),
        sa.Column('work_id', sa.UUID(), nullable=False),
    ...
    op.create_table('project_works',
        ...
        sa.Column('work_id', sa.UUID(), nullable=False),
        sa.Column('quantity', sa.NUMERIC(precision=10, scale=2), nullable=False),
        sa.Column('summ', sa.NUMERIC(precision=10, scale=2), nullable=True),
        sa.Column('signed', sa.BOOLEAN(), nullable=False),
    ...
    op.create_table('project_schedules',
        sa.Column('project_schedule_id', sa.UUID(), nullable=False),
        sa.Column('work_id', sa.UUID(), nullable=False),
        sa.Column('quantity', sa.NUMERIC(precision=10, scale=2), nullable=False),
