...
from app.schemas.place_relation_schemas import (
    ...
    ProjectPlaceRelationBulkSchema, ShiftPlaceRelationBulkSchema,
)
...
project_place_relation_bulk_model = generate_swagger_model(ProjectPlaceRelationBulkSchema(), "ProjectPlaceRelationBulk")
shift_place_relation_bulk_model = generate_swagger_model(ShiftPlaceRelationBulkSchema(), "ShiftPlaceRelationBulk")
...
project_place_relation_bulk_response = Model("ProjectPlaceRelationBulkResponse", {"msg": fields.String(required=True), "project_place_relations": fields.List(fields.Nested(project_place_relation_model))})
shift_place_relation_bulk_response = Model("ShiftPlaceRelationBulkResponse", {"msg": fields.String(required=True), "shift_place_relations": fields.List(fields.Nested(shift_place_relation_model))})
project_place_relation_bulk_delete_response = Model("ProjectPlaceRelationBulkDeleteResponse", {"msg": fields.String(required=True), "deleted_count": fields.Integer(required=True)})
shift_place_relation_bulk_delete_response = Model("ShiftPlaceRelationBulkDeleteResponse", {"msg": fields.String(required=True), "deleted_count": fields.Integer(required=True)})
