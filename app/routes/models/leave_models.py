...
leave_model = Model(
    ...
    "start_date": fields.Integer(required=True, description="Дата начала, Unix epoch milliseconds"),
    "end_date": fields.Integer(required=True, description="Дата окончания, Unix epoch milliseconds"),
    ...
    "created_at": fields.Integer(required=True, description="Когда создан, Unix epoch milliseconds"),
        "updated_by": fields.String(required=False, description="Кем изменен"),
    "updated_at": fields.Integer(required=False, description="Когда изменен, Unix epoch milliseconds"),
