...
project_work_brief_model = Model(
    "ProjectWorkBrief",
    {
...
shift_report_details_msg_model = Model(
...
shift_report_details_many_msg_model = Model(
...
shift_report_details_by_report_ids = Model(
...
shift_report_details_response = Model(
...
shift_report_details_all_response = Model(
    "ShiftReportDetailsAllResponse",
    {
        "msg": fields.String(required=True, description="Response message"),
        "shift_report_details": fields.List(
            fields.Nested(shift_report_details_model),
