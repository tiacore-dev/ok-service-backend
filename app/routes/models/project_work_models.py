...
project_work_model = Model('ProjectWork', {
    ...
    "created_at": fields.Integer(required=True, description="Unix epoch milliseconds: project work creation time"),
...
project_work_msg_many_model = Model('ProjectWorkManyMessage', {
    "msg": fields.String(required=True, description="Response message"),
