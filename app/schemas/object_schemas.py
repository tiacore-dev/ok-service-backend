...
class ObjectCreateSchema(Schema):
    ...
    status = fields.String(required=False, validate=[validate_object_status_exists])
    city = fields.String(
        required=True,
...
class ObjectEditSchema(Schema):
    ...
    status = fields.String(
        required=False, allow_none=True, validate=[validate_object_status_exists]
    )
    manager = fields.String(
        required=False, validate=[validate_user_exists], allow_none=True
    )
