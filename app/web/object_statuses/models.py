...
object_status_all_response = Model(
    "ObjectStatusAllResponse",
    {
        "msg": fields.String(required=True, description="Сообщение."),
        "object_statuses": fields.List(
            fields.Nested(object_status_model),
...
object_status_filter_parser.add_argument(
    ...
    type=str,
    required=False,
    help="Фильтр по идентификатору статуса объекта.",
)
object_status_filter_parser.add_argument(
