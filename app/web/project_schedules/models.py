...
project_schedule_model = Model(
    "ProjectSchedule",
    {
        "project_schedule_id": fields.String(
            required=True, description="ID of the project schedule"
        ),
...
project_schedule_msg_model = Model(
...
project_schedule_response = Model(
...
project_schedule_all_response = Model(
    "ProjectScheduleAllResponse",
    {
        "msg": fields.String(required=True, description="Response message"),
        "project_schedules": fields.List(
            fields.Nested(project_schedule_model), description="List of project schedules"
        ),
    },
)
...
project_schedule_filter_parser.add_argument("work", type=str, help="Filter by work ID")
project_schedule_filter_parser.add_argument(
