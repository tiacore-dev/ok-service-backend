...
notification_model = Model(
    "Notification",
    {
        ...
        "message": fields.String(
            required=True, description="Message that you want to send in web-push"
        ),
    },
)
...
subscription_all_response = Model(
    "SubscriptionAllResponse",
    {
        "msg": fields.String(description="Response message"),
        "subscriptions": fields.List(
            fields.Nested(subscription_model), description="List of subscriptions"
        ),
    },
)
